    ...
    <div className="container">
      ...
      style={{
        ...
        <div className="relative">
          ...
          <p className="text-center text-lg ms:text-xl max-w-xs mx-auto text-white/70 px-4 mt-5 tracking-tight">Achieve clear, imapctful results without the complexity.</p>
